...
if __name__ == "__main__":
    ...
    parser.add_argument('--how2dir', default="data/vmh")
    args = parser.parse_args()

    raw_caption_json = os.path.join(args.how2dir, "raw_caption_with_headlines.json")
    raw_caption_pickle = os.path.join(args.how2dir, "raw_caption_with_headlines.pkl")
    raw_caption_dedup_pickle = os.path.join(args.how2dir, "raw_caption_with_headlines_dedup.pkl")

    if os.path.exists(raw_caption_pickle):
        print(raw_caption_pickle, 'exists - removing..')
        os.remove(raw_caption_pickle)

    if os.path.exists(raw_caption_dedup_pickle):
        print(raw_caption_dedup_pickle, 'exists - removing..')
        os.remove(raw_caption_dedup_pickle)

    def convert_to_pickle(src_fn, tgt_fn):
        with open(src_fn, encoding='utf-8') as fd:
